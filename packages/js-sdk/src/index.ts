export { AgenticCRM, AgenticCRMError } from './client'
export type { SDKConfig } from './config'
export { LeadsClient } from './leads'
export type { Lead, Contact, LeadSource, LeadStage, CreateLeadInput, UpdateLeadInput } from './leads'
...
export type { Deal, DealStage, CreateDealInput, UpdateDealInput } from './deals'
export { AgentsClient } from './agents'
export type { Agent, AgentRole, AgentStatus, CreateAgentInput, UpdateAgentInput } from './agents'
export { ActivitiesClient } from './activities'
export type { Activity, ActivityType, CreateActivityInput } from './activities'
export { SequencesClient } from './sequences'
export type { Sequence, SequenceStep, CreateSequenceInput, UpdateSequenceInput } from './sequences'
