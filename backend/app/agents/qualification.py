...
@celery_app.task(name="agents.qualification.score_lead", bind=True, max_retries=3)
...
@celery_app.task(name="agents.qualification.route_lead", bind=True, max_retries=3)
def route_lead(self, lead_id: int):
    """
